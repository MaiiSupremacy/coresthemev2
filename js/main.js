...
function initCursor() {
    ...
    const interactiveElements = 'a, button, .team-member, .card-link, .slider-arrow, .dot, .filter-btn, .milestone-link';
...
if (console && typeof console.log === 'function') {
    console.log('%c🌊 CORES Theme V2.1.0', 'color: #05BFDB; font-size: 20px; font-weight: bold;');
